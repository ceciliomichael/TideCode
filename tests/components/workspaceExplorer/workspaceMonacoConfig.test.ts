...
test('workspace Monaco resolves common and special file languages', () => {
  ...
  assert.equal(resolveWorkspaceMonacoLanguage('Dockerfile.dev'), 'dockerfile')
  assert.equal(resolveWorkspaceMonacoLanguage('Makefile.local'), 'makefile')
  assert.equal(resolveWorkspaceMonacoLanguage('.env'), 'ini')
  assert.equal(resolveWorkspaceMonacoLanguage('.env.local'), 'ini')
  assert.equal(resolveWorkspaceMonacoLanguage('.env.development.local'), 'ini')
